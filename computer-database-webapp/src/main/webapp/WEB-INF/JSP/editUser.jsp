                    ...
                    <form:form action="" method="POST">
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="username" name="username" placeholder="Username" value="${userDetails.username}" />
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" id="password" name="password" placeholder="Password" value="${userDetails.password}" />
                            </div>
                            <div class="form-group">
                                <label for="enabled">Enabled</label>
                                <input type="checkbox" id="enabled" name="enabled" checked="${userDetails.enabled}" />
                            </div>
                            <div class="form-group">
                                <label for="role">Role</label>
                                <select class="form-control" id="role" name="role" >
                                    <c:if test="${userDetails.authorities == \"[ROLE_USER]\"}">
                                    <option value="ROLE_USER" selected>USER</option>
                                    </c:if>
                                    <c:if test="${userDetails.authorities != \"[ROLE_USER]\"}">
                                    <option value="ROLE_USER">USER</option>
                                    </c:if>
                                    <c:if test="${userDetails.authorities == \"[ROLE_ADMIN]\"}">
                                    <option value="ROLE_USER" selected>ADMIN</option>
                                    </c:if>
                                    <c:if test="${userDetails.authorities != \"[ROLE_ADMIN]\"}">
