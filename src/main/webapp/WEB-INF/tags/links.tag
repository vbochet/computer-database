...
<c:choose>
    ...
    <c:when test="${target == 'dashboardPrev'}"><c:url value="/dashboard?prev&npage=${pagenb}&displayBy=${displayBy}&orderBy=${orderBy}"/></c:when>
    <c:when test="${target == 'dashboardNext'}"><c:url value="/dashboard?next&npage=${pagenb}&displayBy=${displayBy}&orderBy=${orderBy}"/></c:when>
    <c:when test="${target == 'dashboardOther'}"><c:url value="/dashboard?npage=${pagenb}&displayBy=${displayBy}&orderBy=${orderBy}"/></c:when>
